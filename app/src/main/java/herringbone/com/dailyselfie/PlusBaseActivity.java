...
public abstract class PlusBaseActivity extends Activity
    ...
    /**
     * Called when the revokes access to this app.
     */
    ...
    /**
     * Called when the  is disconnected.
     */
...
//                        Scopes.PLUS_ME).build();
        mPlusClient = new GoogleApiClient.Builder(this)
                ...
                .setAccountName("aplee72e@gmail.com")
                .build();
        mPlusClient.connect();
    }
    ...
    /**
     * Connect the  only if a connection isn't already in progress.  This will
    ...
    /**
     * Disconnect the  only if it is connected (otherwise, it can throw an error.)
